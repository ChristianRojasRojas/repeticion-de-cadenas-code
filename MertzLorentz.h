...
#ifndef PROYECT_REPETICION_DE_CADENAS_MERTZLORENTZ_H
...
void mertzLorentz(string palabra) {
    ...
    for (auto element: finalResults){
        ...
        cout << "La subcadena \"" << mitadPalabra <<"\" se repite " << element.second+1 << " veces" << endl;
    }
}

#define PROYECT_REPETICION_DE_CADENAS_MERTZLORENTZ_H

#endif //PROYECT_REPETICION_DE_CADENAS_MERTZLORENTZ_H
